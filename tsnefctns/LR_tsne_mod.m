function [ydata, cost] = LR_tsne_mod(X, labels, no_dims, initial_dims, perplexity, eta)
...
%     
    ...
    % Run t-SNE
    if initial_solution
        [ydata, cost] = LR_tsne_p_mod(eta, P, labels, ydata);
    else
        [ydata, cost] = LR_tsne_p_mod(eta, P, labels, no_dims);
    end
